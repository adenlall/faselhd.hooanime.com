    ...
    return(
        <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
            <div className="items-center grid-flow-col">
                ...
                <p><span className="font-bold">{process.env.NAME}</span><br/>Copyright © 2023 - All right reserved | developed & designed by <a href="https://github.com/adenlall">adenlall</a>, read more on <Link href={"/dmca"}>DMCA</Link>.</p>
            </div> 
